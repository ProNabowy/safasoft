...
export default function UploadLogo({ formik }) {
    ...
    const notify = () => toast("The file is too large. Please upload a file smaller than 500KB", { position: "bottom-right" });
        ...
        <StyledStackContainer gap={6} direction={'column'}>
            ...
            <StyledCircleContainer>
                ...
                <StyledCircle>
                    ...
                    {!formik.values?.company_avatar && <StyledIcon className="fa-regular fa-image"></StyledIcon>}
                    ...
                    {formik.values?.company_avatar && <StyledImage src={URL.createObjectURL(formik.values?.company_avatar || {})} />}

                </StyledCircle>

            </StyledCircleContainer>

            <input type='file' accept="image/*" onChange={handleChange} maxLength={1} hidden id='upload-logo' />
